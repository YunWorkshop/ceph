...
OPTION(osd_pool_default_mclock_res, OPT_DOUBLE, 1000.0)
OPTION(osd_pool_default_mclock_wgt, OPT_DOUBLE, 500.0)
OPTION(osd_pool_default_mclock_lim, OPT_DOUBLE, 0.0)
...
OPTION(osd_op_num_threads_per_shard, OPT_INT, 1)
...
OPTION(bluestore_throttle_latency_min, OPT_DOUBLE, 300)
OPTION(bluestore_throttle_latency_max, OPT_DOUBLE, 500)
OPTION(bluestore_throttle_window_avg, OPT_DOUBLE, 0.5)
